...
public class RestMock {
     ...
     * @return
     */
    public String sendPost(Map<String, Object> jsonMap) {

        String uri = "https://appservice.lzu.edu.cn/api/eusp-unify-terminal/app-user/login";
     ...
     * @return
     */
    public String sendGet(String loginToken) {

        Map<String, String> uriMap = new HashMap<>(6);
        uriMap.put("loginToken", loginToken);
        ResponseEntity responseEntity = restTemplate.getForEntity(generateRequestParameters("https", "appservice.lzu.edu.cn/api/eusp-unify-terminal/app-user/userInfo", uriMap), String.class);
